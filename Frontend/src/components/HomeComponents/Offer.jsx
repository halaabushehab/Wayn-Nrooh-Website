...
export function Offer() {
  ...
  return (
    <div className="flex items-center justify-center my-20">
      <div className="w-full max-w-6xl rounded-lg overflow-hidden shadow-lg flex flex-col md:flex-row-reverse">
        ...
        <div className="md:w-1/2 relative aspect-[16/9] md:aspect-auto h-64 md:h-auto">
          <img
