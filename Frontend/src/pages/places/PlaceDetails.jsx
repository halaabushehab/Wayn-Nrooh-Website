    ...
    <>
      ...
      >
        <button
          ...
          className="bg-white w-12 h-12 rounded-full shadow-lg flex items-center justify-center hover:bg-gray-100 transition-all duration-300 hover:shadow-xl"
        >
          <ChevronLeft className="w-6 h-6 text-gray-700 rotate-90" />
        </button>
      </div>
      ...
      >
        ...
        <div className="absolute top-32 left-1/2 transform -translate-x-1/2 flex gap-3 flex-wrap justify-center max-w-4xl px-4">
          {place.categories.map((category, index) => (
            <span
              key={index}
              className="bg-white/10 backdrop-blur-md text-white border border-white/30 px-5 py-2 rounded-full text-sm font-medium
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          <div className="max-w-4xl">
            {/* Price and Rating */}
            <div className="flex items-center space-x-3 space-x-reverse rtl:space-x-reverse mb-4">
              <span className="bg-gradient-to-r from-yellow-400 to-amber-500 text-black px-4 py-1.5 rounded-full text-sm font-bold shadow-lg">
              ...
              <div className="flex items-center bg-white/10 backdrop-blur-md px-3 py-1.5 rounded-full">
                ...
                <span className="ms-1 text-white/70 text-sm">({ratings.length})</span>
              </div>

              <button
                onClick={sharePlace}
                className="bg-white/10 backdrop-blur-md p-2 rounded-full hover:bg-white/20 transition-all duration-300"
              >
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white drop-shadow-md mb-4 animate-fadeIn">
              {place.name}
            </h1>
            <p
              className="text-xl text-gray-200 max-w-2xl animate-fadeIn opacity-0"
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              {/* Gallery Section */}
              <div className="bg-white rounded-3xl shadow-xl overflow-hidden transform hover:shadow-2xl transition duration-500">
                <div className="p-8">
                        ...
                        <div
                          ...
                          className={`cursor-pointer rounded-xl overflow-hidden transition-all duration-300 ${
                            activeImageIndex === idx
                              ? "ring-4 ring-purple-500 shadow-lg transform scale-[0.98]"
                ...
                <div className="p-8">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex items-center bg-purple-50 px-3 py-1.5 rounded-full">
                      <StarIcon className="w-5 h-5 text-purple-600 fill-purple-600" />
                      <span className="ms-1 text-purple-800 font-semibold">{averageRating}</span>
                      <span className="ms-1 text-purple-600/70 text-sm">({ratings.length})</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-purple-50 rounded-2xl p-6 mb-8">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                      <div className="text-center">
                        ...
                        <p className="text-purple-700/70 text-sm">بناءً على {ratings.length} تقييمات</p>
                      </div>
                        ...
                        >
                          <div className="flex items-center justify-between mb-3">
                            <div className="flex items-center">
                              ...
                              <div className="mr-3">
                                <h4 className="font-medium text-gray-900">{review.user?.username || "مستخدم"}</h4>
                                <div className="flex items-center">
                                  {[1, 2, 3, 4, 5].map((star) => (
                                    <StarIcon
                                      key={star}
                          ...
                          {review.comment && (
                            <p className="text-gray-700 mt-2 bg-gray-50 p-4 rounded-lg">{review.comment}</p>
                          )}
                        </div>
                      ))
                    ) : (
                  ...
                  {userId && (
                    <div id="rating-form" className="mt-8 pt-6 border-t border-gray-100">
                      ...
                      {!submitted ? (
                        <form onSubmit={handleSubmitRating} className="bg-gray-50 p-6 rounded-xl">
                          ...
                          <div className="text-center min-h-[1.5rem] mb-4">
                            <p
                              className={`text-sm font-medium ${hover !== null || rating !== null ? "text-purple-600" : "text-gray-500"}`}
                            >
                          ...
                          <textarea
                            className="w-full p-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300"
                          ...
                          <button
                            type="submit"
                            className="mt-4 w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 
                                      text-white font-medium py-3 px-4 rounded-xl transition duration-300 shadow-md hover:shadow-lg"
                          >
                            إرسال التقييم
                          </button>
                        </form>
                        ...
                        <div className="text-center py-8 bg-purple-50 rounded-xl">
                          <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                            <StarIcon className="w-8 h-8 text-purple-600 fill-purple-600" />
                          </div>
                          <p className="text-purple-700 font-medium mb-3">شكراً لتقييمك!</p>
                          <button
                            onClick={resetRating}
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                {/* Place Info Card */}
                <div className="bg-gradient-to-br from-purple-600 to-indigo-700 text-white p-8 rounded-3xl shadow-xl overflow-hidden relative">
                  ...
                  <h3 className="text-xl font-bold mb-6 text-center pb-4 border-b border-white/20 relative z-10">
                    معلومات المكان
                  </h3>
                  ...
                  <div className="space-y-5 relative z-10">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-white/80 text-sm">سعر التذكرة</h4>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-white/80 text-sm">ساعات العمل</h4>
                        <p className="font-semibold text-lg">{place.working_hours}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-white/80 text-sm">الموقع</h4>
                        <p className="font-semibold text-lg">{place.city || "الأردن"}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="text-white/80 text-sm">الموسم المناسب</h4>
                        <p className="font-semibold text-lg">{place.season || "طوال العام"}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <button
                    onClick={handleClick}
                    className="w-full mt-8 bg-white hover:bg-white/90 text-indigo-700 font-bold py-3 px-4 rounded-xl transition duration-300 
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-3">
                      <button
                        ...
                        className="w-full flex items-center justify-between bg-gradient-to-r from-gray-50 to-gray-100 hover:from-gray-100 hover:to-gray-200 
                                  p-4 rounded-xl transition border border-gray-200 group"
                      >
                        <span className="font-medium group-hover:text-purple-700 transition-colors">
                          أماكن قريبة مني
                        </span>
                        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-sm group-hover:bg-purple-100 transition-colors">
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-between bg-gradient-to-r from-gray-50 to-gray-100 hover:from-gray-100 hover:to-gray-200 
                                  p-4 rounded-xl transition border border-gray-200 group"
                      >
                        <span className="font-medium group-hover:text-purple-700 transition-colors">أماكن مشابهة</span>
                        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-sm group-hover:bg-purple-100 transition-colors">
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-between bg-gradient-to-r from-gray-50 to-gray-100 hover:from-gray-100 hover:to-gray-200 
                                  p-4 rounded-xl transition border border-gray-200 group"
                      >
                        <span className="font-medium group-hover:text-purple-700 transition-colors">مشاركة المكان</span>
                        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-sm group-hover:bg-purple-100 transition-colors">
